...
# installed.
TCL_PREFIX='/alma/ACS-2014.4/tcltk'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/alma/ACS-2014.4/tcltk'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tcl8.5.15/unix -ltcl8.5'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/alma/ACS-2014.4/tcltk/include'
...
# compiled.
TCL_SRC_DIR='/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tcl8.5.15'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/alma/ACS-2014.4/tcltk/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tcl8.5.15/unix -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tcl8.5.15/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/alma/ACS-2014.4/tcltk/lib/libtclstub8.5.a'
