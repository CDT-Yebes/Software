static char rcsid[] = "$Header: d:\\CVS/prj/RosettaMan/rman.c,v 1.151 2003/03/29 22:44:08 phelps Exp $";
...
/*
  ...
  output as (9)
	...
	LaTeX, LaTeX2e, RTF, Perl pod, MIME
...
/*	FILE *macros; -- interpret -man macros? */
	...
	static struct { char letter; int arg; char *longnames; char *desc; } option[] = {
		{ 'f', 1, "filter", " <ASCII|roff|TkMan|Tk|Sections|HTML|MIME|LaTeX|LaTeX2e|RTF|pod>" },
...
*/
		   ...
		   case 'v': /*case '?':*/
			printf("PolyglotMan v" POLYGLOTMANVERSION " of $Date: 2003/03/29 22:44:08 $\n");
			exit(0);
