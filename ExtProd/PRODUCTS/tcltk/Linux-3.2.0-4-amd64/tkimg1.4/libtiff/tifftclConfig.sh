...
# build directory.
tifftcl_BUILD_LIB_SPEC='-L/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tkimg1.4/libtiff -ltifftcl3.9.4'

# String to pass to linker to pick up the tifftcl library from its
# installed directory.
tifftcl_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/tifftcl3.9.4 -ltifftcl3.9.4'
...
# build directory.
tifftcl_BUILD_STUB_LIB_SPEC='-L/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tkimg1.4/libtiff -ltifftclstub3.9.4'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/tifftcl3.9.4 -ltifftclstub3.9.4'

# String to pass to linker to pick up the tifftcl stub library from its
# build directory.
tifftcl_BUILD_STUB_LIB_PATH='/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tkimg1.4/libtiff/libtifftclstub3.9.4.a'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_PATH='/alma/ACS-2014.4/tcltk/lib/tifftcl3.9.4/libtifftclstub3.9.4.a'
