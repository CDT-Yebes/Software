...
zlibtcl_LIB_FILE=libzlibtcl1.2.5.so

# String to pass to linker to pick up the zlibtcl library from its
# build directory.
zlibtcl_BUILD_LIB_SPEC='-L/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tkimg1.4/zlib -lzlibtcl1.2.5'

# String to pass to linker to pick up the zlibtcl library from its
# installed directory.
zlibtcl_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/zlibtcl1.2.5 -lzlibtcl1.2.5'

# The name of the zlibtcl stub library (a .a file):
zlibtcl_STUB_LIB_FILE=libzlibtclstub1.2.5.a

# String to pass to linker to pick up the zlibtcl stub library from its
# build directory.
zlibtcl_BUILD_STUB_LIB_SPEC='-L/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tkimg1.4/zlib -lzlibtclstub1.2.5'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/zlibtcl1.2.5 -lzlibtclstub1.2.5'

# String to pass to linker to pick up the zlibtcl stub library from its
# build directory.
zlibtcl_BUILD_STUB_LIB_PATH='/home/almamgr/ACS_javarias/ExtProd/PRODUCTS/tcltk/Linux-3.2.0-4-amd64/tkimg1.4/zlib/libzlibtclstub1.2.5.a'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_PATH='/alma/ACS-2014.4/tcltk/lib/zlibtcl1.2.5/libzlibtclstub1.2.5.a'
