...
# String to pass to linker to pick up the zlibtcl library from its
# installed directory.
zlibtcl_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/Img1.4 -lzlibtcl1.2.5'
...
# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/Img1.4 -lzlibtclstub1.2.5'
...
# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_PATH='/alma/ACS-2014.4/tcltk/lib/Img1.4/libzlibtclstub1.2.5.a'
