package ifneeded zlibtcl 1.2.5 \
    [list load [file join $dir libzlibtcl1.2.5.so]]
package ifneeded pngtcl 1.4.3 \
    [list load [file join $dir libpngtcl1.4.3.so]]
package ifneeded tifftcl 3.9.4 \
    [list load [file join $dir libtifftcl3.9.4.so]]
package ifneeded jpegtcl 8.2 \
    [list load [file join $dir libjpegtcl8.2.so]]
