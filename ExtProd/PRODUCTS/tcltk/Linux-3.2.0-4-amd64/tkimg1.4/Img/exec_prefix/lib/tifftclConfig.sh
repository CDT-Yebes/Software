...
# String to pass to linker to pick up the tifftcl library from its
# installed directory.
tifftcl_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/Img1.4 -ltifftcl3.9.4'
...
# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/Img1.4 -ltifftclstub3.9.4'
...
# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_PATH='/alma/ACS-2014.4/tcltk/lib/Img1.4/libtifftclstub3.9.4.a'
