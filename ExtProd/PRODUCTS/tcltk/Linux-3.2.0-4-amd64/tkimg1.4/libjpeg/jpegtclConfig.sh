...
# String to pass to linker to pick up the jpegtcl library from its
# installed directory.
jpegtcl_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/jpegtcl8.2 -ljpegtcl8.2'
...
# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/jpegtcl8.2 -ljpegtclstub8.2'
...
# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_PATH='/alma/ACS-2014.4/tcltk/lib/jpegtcl8.2/libjpegtclstub8.2.a'
