...
# String to pass to linker to pick up the tkimg library from its
# installed directory.
tkimg_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/tkimg1.4 -ltkimg1.4'
...
# String to pass to linker to pick up the tkimg stub library from its
# installed directory.
tkimg_STUB_LIB_SPEC='-L/alma/ACS-2014.4/tcltk/lib/tkimg1.4 -ltkimgstub1.4'
...
# String to pass to linker to pick up the tkimg stub library from its
# installed directory.
tkimg_STUB_LIB_PATH='/alma/ACS-2014.4/tcltk/lib/tkimg1.4/libtkimgstub1.4.a'
